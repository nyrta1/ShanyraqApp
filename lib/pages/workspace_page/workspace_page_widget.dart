...
import 'workspace_page_model.dart';
export 'workspace_page_model.dart';

class WorkspacePageWidget extends StatefulWidget {
  const WorkspacePageWidget({super.key});

  static String routeName = 'WorkspacePage';
  static String routePath = '/workspacePage';

  @override
  State<WorkspacePageWidget> createState() => _WorkspacePageWidgetState();
}

class _WorkspacePageWidgetState extends State<WorkspacePageWidget> {
  late WorkspacePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkspacePageModel());
