...
import 'c_c_t_v_list_model.dart';
export 'c_c_t_v_list_model.dart';

class CCTVListWidget extends StatefulWidget {
  const CCTVListWidget({super.key});

  static String routeName = 'CCTVList';
  static String routePath = '/cCTVList';

  @override
  State<CCTVListWidget> createState() => _CCTVListWidgetState();
}

class _CCTVListWidgetState extends State<CCTVListWidget>
    with TickerProviderStateMixin {
  late CCTVListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CCTVListModel());
